package org.iesalandalus.programacion.alquilervehiculos.vista.grafica.utilities;
...
public class Dialogos {
	...
	// LocalizadorRecursos.class.getResource("estilos/estilos.css").toExternalForm();
